<template>
    <AppLayout>
        <template #title>Editar Usuario: {{ user.name }}</template>
        ...
        <div class="user-form-page">
            ...
            <!-- Main form -->
            <form @submit.prevent="submitMain" enctype="multipart/form-data">
                <!-- Section 1: User data -->
                <div class="form-section">
                    ...
                    <div class="form-section__body">
                        <div class="form-grid">
                            ...
                            <div></div>
                            <AppInput label="Contraseña" type="password" v-model="form.password" :error="form.errors.password" placeholder="Dejar en blanco para no cambiar" />
                            <AppInput label="Confirmar contraseña" type="password" v-model="form.password_confirmation" placeholder="Dejar en blanco para no cambiar" />
                        </div>
            ...
            <div class="form-section" style="margin-top: 2rem;">
                <div class="form-section__header">
                    <h2 class="form-section__title">Restablecer Contraseña</h2>
                    <p class="form-section__desc">Establece una nueva contraseña para este usuario</p>
                </div>
                <div class="form-section__body">
                    <form @submit.prevent="submitPassword">
                        <div class="form-grid">
                            <AppInput label="Nueva contraseña" type="password" v-model="pwForm.password" :error="pwForm.errors.password" required />
                            <AppInput label="Confirmar contraseña" type="password" v-model="pwForm.password_confirmation" :error="pwForm.errors.password_confirmation" required />
                        </div>
                        <div class="form-actions" style="margin-top: 1rem;">
                            <AppButton type="submit" variant="secondary" :loading="pwForm.processing">
...
const form = useForm({
    ...
    bypass_schedule: !!props.user.bypass_schedule,
    is_active: !!props.user.is_active,
    can_view_profits: !!props.user.can_view_profits,
    photo: null,
})
...
const photoPreview = ref(
    props.user.photo ? `/storage/${props.user.photo}` : null
)
...
function submitPassword() {
    pwForm.put(`/users/${props.user.id}/reset-password`, {
        preserveScroll: true,
