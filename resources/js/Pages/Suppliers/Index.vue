<template>
    <AppLayout>
        ...
        <div class="suppliers-page">
            ...
            <div class="page-header">
                <div>
                    ...
                    <p class="page-desc">Administra los proveedores de tus productos</p>
                </div>
                <a href="/suppliers/create" @click.prevent="$inertia.visit('/suppliers/create')" class="btn-primary">
            ...
            <!-- Table -->
            <AppTable :columns="columns" :rows="suppliers.data">
                ...
                <template #cell(actions)="{ row }">
                    <div class="actions-group">
                        <a :href="`/suppliers/${row.id}/edit`" @click.prevent="$inertia.visit(`/suppliers/${row.id}/edit`)" class="action-btn action-edit" title="Editar">
                        ...
                        <button class="action-btn action-toggle" :title="row.is_active ? 'Desactivar' : 'Activar'" @click="toggleSupplier(row)">
            ...
            <!-- Pagination -->
            <div v-if="suppliers.links && suppliers.last_page > 1" class="pagination">
        ...
        <ConfirmModal
            ...
            :message="`¿Estás seguro de eliminar el proveedor '${deleteModal.supplier?.name}'? Asegúrate de que no tenga productos asociados.`"
...
const columns = [
    ...
    { key: 'products_count', label: 'Productos asociados' },
    { key: 'is_active', label: 'Estado' },
    { key: 'actions', label: 'Acciones', width: '120px' },
]

function toggleSupplier(supplier) {
    router.patch(`/suppliers/${supplier.id}/toggle-status`, {}, { preserveState: true })
}

const deleteModal = reactive({ show: false, supplier: null })
...
function executeDelete() {
    router.delete(`/suppliers/${deleteModal.supplier.id}`, {
        preserveState: true,
